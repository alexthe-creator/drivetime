...
// ============================================================
// SETUP INSTRUCTIONS:
// 1. Go to script.google.com and create a new project (or open existing)
...
// 4. Add a property: Name = ANTHROPIC_API_KEY, Value = your key from console.anthropic.com
//    (This enables Claude to intelligently parse newsletters into clean sections)
// 5. Click Deploy → New deployment (or Manage deployments → Edit for existing)
// 6. Type: Web App
// 7. Execute as: Me
// 8. Who has access: Anyone
// 9. Click Deploy and copy the Web App URL
// 10. Paste that URL into DriveTime Settings → Newsletter API URL
//
// The script fetches your FT and Axios emails, then uses Claude AI to parse
// them into clean, listenable sections — no ads, no URLs, deals chunked correctly.
// ============================================================
